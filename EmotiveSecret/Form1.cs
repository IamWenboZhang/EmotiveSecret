...
#region 各种数据 
            ...
            //MyMsgBoxShow(tempmsg+"\n");
            //DisplayThinkGearValue(EEG_DATA);
            //Drawli();
            DrawLineGraph(map);
        }

        ////显示
        //private void DisplayThinkGearValue(ThinkGearValue eeg_data)
        //{
        //    this.Invoke(new MethodInvoker(delegate ()
        //    {
        //        this.lb_Attention.Text = eeg_data.Attention.ToString();
        //        this.lb_BlinkStrength.Text = eeg_data.BlinkStrength.ToString();
        //        this.lb_EegPowerAlpha1.Text = eeg_data.EegPowerAlpha1.ToString();
        //        this.lb_EegPowerAlpha2.Text = eeg_data.EegPowerAlpha2.ToString();
        //        this.lb_EegPowerBeta1.Text = eeg_data.EegPowerBeta1.ToString();
        //        this.lb_EegPowerBeta2.Text = eeg_data.EegPowerBeta2.ToString();
        //        this.lb_EegPowerDelta.Text = eeg_data.EegPowerDelta.ToString();
        //        this.lb_EegPowerGamma1.Text = eeg_data.EegPowerGamma1.ToString();
        //        this.lb_EegPowerGamma2.Text = eeg_data.EegPowerGamma2.ToString();
        //        this.lb_EegPowerTheta.Text = eeg_data.EegPowerTheta.ToString();
        //        this.lb_Meditation.Text = eeg_data.Meditation.ToString();
        //        this.lb_MentalEffort.Text = eeg_data.MentalEffort.ToString();
        //        this.lb_Positivity.Text = eeg_data.Positivity.ToString();
        //        this.lb_TaskFamiliarity.Text = eeg_data.TaskFamiliarity.ToString();
        //    }));
        //}
        ...
        {
            int heighy = 500000 / heigh;
            int result = (500000 - value) / heighy;
            return result;
        }
